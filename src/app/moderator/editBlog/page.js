...
//         <Loader2 className="w-8 h-8 animate-spin text-[#806149]" />
//       </div>
//     );
//   }
...
//                         type="button"
//                         onClick={addTag}
//                         className="px-4 py-2 bg-[#806149] text-white text-sm font-medium rounded-lg hover:bg-[#806149] transition-colors"
//                       >
//                         Add
//                       </button>
//                     </div>
...
//                 className="flex items-center gap-2 px-6 py-3 bg-[#806149] text-white font-medium rounded-lg hover:bg-[#806149] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
//               >
//                 {isSubmitting ? (
//                   <>
                            ...
                            <div
                              ...
                              className={`relative rounded-lg overflow-hidden border border-gray-200 aspect-square transition-all duration-200 ${
                                ...
                                dragOverIndex === index && draggedIndex !== index && draggedIndex !== null 
                                  ? 'ring-2 ring-[#806149] ring-offset-2' 
                                  : ''
                              }`}
                            >
                              {/* Drag handle */}
