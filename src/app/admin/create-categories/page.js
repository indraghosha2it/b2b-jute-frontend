 ...
 const fetchCategories = async () => {
  ...
  const handleAddSubcategorySubmit = async (e) => {
    ...
    try {
      ...
      for (const subcategory of validSubcategories) {
        try {
          const response = await fetch(`https://b2b-jute-backend.vercel.app/api/categories/${subcategoryModal.category._id}/subcategories`, {
            method: 'POST',
            headers: { 
  ...
  const handleEditSubcategorySubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://b2b-jute-backend.vercel.app/api/categories/${editSubcategoryModal.category._id}/subcategories/${editSubcategoryModal.subcategory._id}`,
        {
          method: 'PUT',
          headers: { 
            'Authorization': `Bearer ${token}`,
  ...
  const handleAddChildSubcategorySubmit = async (e) => {
    ...
    try {
      ...
      for (const child of validChildren) {
        try {
          const response = await fetch(
            `https://b2b-jute-backend.vercel.app/api/categories/${childSubcategoryModal.category._id}/subcategories/${childSubcategoryModal.subcategory._id}/children`,
            {
              method: 'POST',
              headers: { 
                'Authorization': `Bearer ${token}`,
  ...
  const handleEditChildSubcategorySubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://b2b-jute-backend.vercel.app/api/categories/${editChildSubcategoryModal.category._id}/subcategories/${editChildSubcategoryModal.subcategory._id}/children/${editChildSubcategoryModal.child._id}`,
        {
          method: 'PUT',
          headers: { 
            'Authorization': `Bearer ${token}`,
  ...
  const handleDeleteSubcategoryConfirm = async () => {
    try {
      ...
      if (deleteSubcategoryModal.isChild) {
        url = `https://b2b-jute-backend.vercel.app/api/categories/${deleteSubcategoryModal.categoryId}/subcategories/${deleteSubcategoryModal.subcategoryId}/children/${deleteSubcategoryModal.childId}`;
      } else {
        url = `https://b2b-jute-backend.vercel.app/api/categories/${deleteSubcategoryModal.categoryId}/subcategories/${deleteSubcategoryModal.subcategoryId}`;
      }
  ...
  const handleDeleteConfirm = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://b2b-jute-backend.vercel.app/api/categories/${deleteModal.id}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://b2b-jute-backend.vercel.app/api/categories/${editModal.category._id}`, {
        method: 'PUT',
        headers: { 'Authorization': `Bearer ${token}` },
        body: formDataToSend
      });
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-2 sm:gap-4">
              <Link href="/admin/dashboard" className="p-1.5 sm:p-2 hover:bg-gray-100 rounded-lg transition-colors flex-shrink-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                  ...
                  <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-red-100 text-red-600 text-[10px] sm:text-xs font-medium rounded-full whitespace-nowrap">
                    Admin
                  </span>
                </div>
                <p className="text-xs sm:text-sm text-gray-500 mt-0.5 sm:mt-1 truncate">
                  Manage categories, subcategories, and sub-subcategories with full control
                </p>
              </div>
            </div>
            <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
              <div className="text-xs sm:text-sm text-gray-600 bg-gray-50 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg">
                Total: <span className="font-semibold text-[#85664D]">{categories.length}</span> categories
              </div>
              <button onClick={fetchCategories} className="p-1.5 sm:p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" title="Refresh">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 sticky top-24">
              <div className="p-5 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                  <Plus className="w-5 h-5 text-[#85664D]" />
                  Add New Category
                </h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <>
                      <div 
                        className={`border-2 border-dashed rounded-lg p-4 text-center transition-colors cursor-pointer ${
                          imageError ? 'border-red-300 bg-red-50' : errors.image ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#85664D] hover:bg-orange-50'
                        }`}
                        onClick={() => {
                          setImageError('');
                          fileInputRef.current?.click();
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#85664D] focus:border-transparent outline-none transition ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#85664D] focus:border-transparent outline-none transition"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#85664D] text-white font-medium rounded-lg hover:bg-[#55351C] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                >
                  {isSubmitting ? (
                    <>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="relative w-64">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#85664D] focus:border-transparent outline-none transition placeholder:text-gray-400"
                    />
                  </div>
                </div>
              </div>
                    ...
                    {isLoading ? (
                      <tr>
                        <td colSpan="6" className="px-5 py-8 text-center">
                          <Loader2 className="w-6 h-6 animate-spin mx-auto text-[#85664D]" />
                        </td>
                      </tr>
                        ...
                        <tr key={category._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-5 py-3">
                            <div className="flex items-center justify-end gap-2">
                              <button onClick={() => handleViewClick(category)} className="p-1.5 text-gray-600 hover:text-[#85664D] hover:bg-orange-50 rounded-lg transition-colors" title="View Details">
                              ...
                              <button onClick={() => handleEditClick(category)} className="p-1.5 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 overflow-hidden max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
              ...
              <button onClick={handleViewClose} className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Hash className="w-3.5 h-3.5 text-[#85664D]" />
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-2">
                    <FolderTree className="w-3.5 h-3.5 text-[#85664D]" />
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      {isLoadingSubcategories ? (
                        <div className="flex items-center justify-center py-4">
                          <Loader2 className="w-4 h-4 animate-spin text-[#85664D]" />
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Package className="w-3.5 h-3.5 text-[#85664D]" />
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Calendar className="w-3.5 h-3.5 text-[#85664D]" />
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <User className="w-3.5 h-3.5 text-[#85664D]" />
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Clock className="w-3.5 h-3.5 text-[#85664D]" />
                ...
                <div className="col-span-2 bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <FileText className="w-3.5 h-3.5 text-[#85664D]" />
              ...
              <div className="flex justify-end gap-2 mt-6 pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-medium text-[#85664D] hover:bg-orange-50 rounded-lg transition-colors flex items-center gap-1"
                >
                  <Edit className="w-3.5 h-3.5" />
                  Edit Category
                </button>
    ...
    <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
      ...
      <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
        {viewSubcategoriesModal.isLoading ? (
          <div className="text-center py-12">
            <Loader2 className="w-8 h-8 animate-spin mx-auto text-[#85664D]" />
          ...
          <div className="text-center py-12">
            ...
            <button
              ...
              className="mt-3 px-4 py-2 bg-[#85664D] text-white text-sm rounded-lg hover:bg-[#55351C]"
            >
            ...
            {viewSubcategoriesModal.subcategories.map((sub, index) => {
              ...
              return (
                <div key={sub._id} className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex items-center gap-3 flex-1 flex-wrap">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {/* Child Subcategory Count Badge - Shows number of sub-subcategories */}
                          {childCount > 0 && (
                  ...
                  {/* Child Subcategories - Only visible when expanded */}
                  {viewSubcategoriesModal.expandedChildren[sub._id] && (
      ...
      <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-end">
        <button
          ...
          className="px-4 py-2 bg-[#85664D] text-white text-sm rounded-lg hover:bg-[#55351C] flex items-center gap-2"
        >
          <Plus className="w-4 h-4" />
          Add Subcategory
        </button>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-gray-100 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleAddSubcategorySubmit} className="space-y-4">
                    ...
                    <div key={sub.id} className="flex items-center gap-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#85664D] focus:border-transparent outline-none"
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm text-[#85664D] hover:bg-[#ede4de] rounded-lg transition-colors"
                >
                  <Plus className="w-4 h-4" />
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[#85664D] text-white text-sm font-medium rounded-lg hover:bg-[#ea9354] transition-colors disabled:opacity-50"
                  >
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setChildSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-gray-100 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-blue-50 rounded-lg">
                    <Edit className="w-5 h-5 text-[#85664D]" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900">Edit Subcategory</h3>
                </div>
                <button onClick={() => setEditSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-gray-100 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleEditSubcategorySubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[#85664D] text-white text-sm font-medium rounded-lg hover:bg-[#55351C] transition-colors disabled:opacity-50"
                  >
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setEditChildSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-gray-100 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#85664D]/10 rounded-lg">
                    <Edit className="w-5 h-5 text-[#85664D]" />
                  </div>
                    ...
                    <>
                      <div 
                        className={`border-2 border-dashed rounded-lg p-4 text-center cursor-pointer transition-colors ${
                          editModal.imageError ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#85664D] hover:bg-orange-50'
                        }`}
                        onClick={() => {
