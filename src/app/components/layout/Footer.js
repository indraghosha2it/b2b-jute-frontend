  ...
  return (
    <footer className="relative text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-10 lg:py-8 relative z-10">
        ...
        {/* Main Grid */}
        <div className="lg:grid lg:grid-cols-4 lg:gap-8 flex flex-col space-y-6 lg:space-y-0 mb-4">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left w-full">
            ...
            <div className="flex flex-wrap gap-1.5 mb-3 justify-center lg:justify-start">
              <div className="flex items-center gap-1 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 border border-white/20">
                <HiOutlineBadgeCheck className="text-[#3bc24f] text-xs" />
                <span className="text-xs font-medium text-[#F5E6D3]/90">Verified Supplier</span>
              </div>
              <div className="flex items-center gap-1 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 border border-white/20">
                <FaShieldAlt className="text-[#3bc24f] text-xs" />
                <span className="text-xs font-medium text-[#F5E6D3]/90">Trade Assurance</span>
              </div>
            </div>

            {/* Eco-Friendly Badge */}
            <div className="flex items-center gap-1 bg-[#3bc24f]/20 backdrop-blur-sm rounded-full px-3 py-1.5 border border-[#3bc24f]/30">
              <FaCheckCircle className="text-[#3bc24f] text-xs" />
              <span className="text-xs font-medium text-[#F5E6D3]">100% Eco-Friendly</span>
            </div>
          </div>
                  ...
                  <li key={link.name}>
                    {link.isButton ? (
                      <button
                        ...
                        className="text-[#F5E6D3]/60 hover:text-[#3bc24f] transition-colors duration-200 text-xs flex items-center gap-1.5 group w-full text-left"
                      >
                        <span className="w-1 h-1 rounded-full bg-[#F5E6D3]/30 group-hover:bg-[#3bc24f] transition-colors"></span>
                        {link.name}
                      </button>
...
//   // Check user and subscription status on mount
//   useEffect(() => {
...
//         {/* Main Grid */}
//         <div className="lg:grid lg:grid-cols-5 lg:gap-6 flex flex-col space-y-6 lg:space-y-0 mb-4">
...
//                 Get B2B updates, new products & exclusive offers
//               </p>
...
//                       : 'bg-[#3bc24f] text-white hover:bg-[#2da63f]'
//                   }`}
//                 >
//                   {isLoading ? (
//                     'Processing...'
...
//                   className="w-full bg-white/10 backdrop-blur-sm text-[#F5E6D3] py-2 rounded-lg text-xs font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20"
//                 >
//                   Login to Subscribe →
//                 </button>
//               )}
...
//               {!user && (
//                 <p className="text-[#F5E6D3]/40 text-[10px] text-center">
//                   Only registered wholesale buyers can subscribe
//                 </p>
//               )}
              
//               {user && isSubscribed && (
//                 <p className="text-[#3bc24f] text-[10px] text-center">
//                   ✓ You're receiving our B2B newsletter
//                 </p>
//               )}
//             </div>
//           </div>
...
//           {/* Column 5: Newsletter Subscription (Desktop) */}
//           <div className="hidden lg:block">
//             <h3 className="text-sm font-semibold text-white mb-3 relative inline-block">
//               Newsletter
//               <span className="absolute -bottom-1 left-0 w-8 h-0.5 bg-gradient-to-r from-[#3bc24f] to-transparent"></span>
...
//                 <button
//                   onClick={() => router.push('/login?redirect=/')}
//                   className="w-full bg-white/10 backdrop-blur-sm text-[#F5E6D3] py-2.5 rounded-lg text-xs font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20"
//                 >
//                   Login to Subscribe →
//                 </button>
//               )}
...
//               {!user && (
//                 <p className="text-[#F5E6D3]/40 text-[10px]">
//                   Only registered wholesale buyers can subscribe
//                 </p>
//               )}
              
//               {user && isSubscribed && (
//                 <p className="text-[#3bc24f] text-[10px]">
//                   ✓ You're receiving our B2B newsletter
//                 </p>
//               )}
...
//                     { icon: <FaLinkedinIn />, href: companyInfo.social.linkedin, label: 'LinkedIn' },
//                     { icon: <FaYoutube />, href: companyInfo.social.youtube, label: 'YouTube' },
//                     { icon: <FaWhatsapp />, href: `https://wa.me/${companyInfo.whatsapp}?text=Hi%20Jute%20Craftify%2C%20I'm%20interested%20in%20your%20jute%20products`, label: 'WhatsApp' },
//                   ].map((social, index) => (
//                     <motion.a
//                       key={index}
//                       href={social.href}
