...
// import { X, ShoppingCart, Eye, Star, Package, Sparkles, ChevronLeft, ChevronRight, Zap, Heart } from 'lucide-react';
// import Link from 'next/link';
// import { motion, AnimatePresence } from 'framer-motion';

// const PromotionalModal = ({ products = [], onClose }) => {
...
//   const productTag = product.promoTag || product.tag;
...
//                   className="ml-auto"
//                 >
//                   <Zap className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-yellow-300" />
//                 </motion.div>
//               </div>
//             </div>
...
//                   <div className="p-3 text-center bg-[#FAF7F2] border-t border-[#E8D5C0]">
//                     <p className="text-[9px] sm:text-[10px] text-gray-400">No images available</p>
//                   </div>
//                 )}
//               </div>
...
//                         </span>
//                       ))}
//                       {product.sizes.filter(s => s.trim()).length > 4 && (
//                         <span className="text-[7px] sm:text-[8px] text-gray-400 self-center">+{product.sizes.length - 4}</span>
//                       )}
//                     </div>
//                   </motion.div>
//                 )}
...
//                         </span>
//                       ))}
//                       {product.quantityBasedPricing.length > 2 && (
//                         <span className="text-[6px] sm:text-[7px] text-gray-400">+{product.quantityBasedPricing.length - 2}</span>
//                       )}
//                     </div>
//                   </motion.div>
//                 )}
...
// // Hook to use the modal - WITH MULTIPLE APPEARANCES
...
//         console.log('📊 Intervals:', data.data.intervals);
//         console.log('📊 Max shows:', data.data.maxShows);
//         console.log('📊 Products from API:', data.data.products);
        
//         setIntervals(data.data.intervals);
//         setMaxShows(data.data.maxShows);
        
//         // Format products - Take only the first product
//         const productsWithTags = data.data.products.slice(0, 1).map(product => ({
...
//           tag: product.promoTag || product.tag || 'Special Offer',
...
//         console.log('✅ Product images:', productsWithTags[0]?.images);
              ...
              <div className="flex items-center justify-between relative z-10">
                ...
                {hasMultipleProducts && (
                  <div className="text-white/80 text-[10px] sm:text-xs">
                    {localCurrentIndex + 1} of {products.length}
                  </div>
                )}
              </div>
            </div>
